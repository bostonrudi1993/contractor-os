...
export const SEGMENTS = {
  otr: {
    ...
    nav: ["dashboard","analyze","boards","compliance","brokers","fleet","finance","payroll","invoices","dispatch","contacts","documents","reports","users","settings","fmcsa","data","deadmiles","lender"],
  ...
  fedex: {
    ...
    nav: ["dashboard","routes","compliance","drivers","dispatch","fleet","finance","payroll","invoices","contacts","documents","contracts","stopprofit","settlement","driverschedule","reports","users","settings","fmcsa","data","lender"],
  ...
  amazon: {
    ...
    nav: ["dashboard","routes","compliance","drivers","dispatch","fleet","finance","payroll","invoices","contacts","documents","contracts","stopprofit","settlement","driverschedule","scorecard","reports","users","settings","fmcsa","data","lender"],
  ...
  lastmile: {
    ...
    nav: ["dashboard","routes","compliance","drivers","dispatch","fleet","finance","payroll","invoices","contacts","documents","contracts","claims","stopprofit","reports","users","settings","fmcsa","data","lender"],
    features: { loadAnalysis:false, brokerScorecard:false, loadBoards:false, routeProfit:true, contractTracker:true, dspMetrics:false, stopMetrics:true },
  },
  usps: {
    ...
    nav: ["dashboard","routes","compliance","drivers","dispatch","fleet","finance","payroll","invoices","contacts","documents","contracts","reports","users","settings","fmcsa","data","lender"],
