  ...
  return (
        <div style={{flex:1,overflowY:"auto",padding:24}}>
          <div style={{maxWidth:700,margin:"0 auto",animation:"fadeUp 0.3s ease"}}>
            ...
            {fmcsaLoading&&<div style={{...S.card,textAlign:"center",color:"#999",fontSize:12,padding:32,animation:"fadeUp 0.3s ease"}}>
            ...
            {!fmcsaLoading&&!fmcsaResult&&!fmcsaError&&<div style={{...S.card,textAlign:"center",color:"#999",fontSize:12,padding:40}}>Enter your USDOT number above and click Lookup → to pull your carrier profile from the FMCSA SAFER database.</div>}
            {fmcsaResult&&(
              <div style={{...S.card,border:`1px solid ${accent}33`}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:16}}>
                  ...
                  <div style={{background:fmcsaResult.opStatus?.toLowerCase().includes("authorized")?"#051a05":"#1a0808",border:`1px solid ${fmcsaResult.opStatus?.toLowerCase().includes("authorized")?"#22c55e44":"#ef444444"}`,borderRadius:6,padding:"6px 14px",textAlign:"center",flexShrink:0}}>
                    ...
                    <div style={{fontSize:9,color:"#999"}}>Operating Status</div>
                  </div>
                </div>
