const NAV_ICONS = {dashboard:"◈",analyze:"⚡",boards:"📋",compliance:"🛡",brokers:"🤝",fleet:"🚛",finance:"💰",routes:"🗺",drivers:"👤",contracts:"📄",reports:"📊",trends:"📈",users:"👥",settings:"⚙",payroll:"💵",invoices:"🧾",dispatch:"📡",contacts:"📞",documents:"📁",data:"💾",fmcsa:"🏛",scorecard:"📊",stopprofit:"📍",settlement:"💳",driverschedule:"📅",claims:"📋",deadmiles:"🛣",lender:"🏦"};
...
export default function Nav({navOpen, setNavOpen, seg, screen, accent, urgentItems, onNav}) {
  return (
    <>
